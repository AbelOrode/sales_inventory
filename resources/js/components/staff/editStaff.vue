                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Update Staff Record</h1>
                                    </div>
                                    <form class="user" @submit.prevent="editStaff" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods:{
            ...
            editStaff(){
                let id = this.$route.params.id;
                axios.patch('/api/staff', this.form)
                    .then(() =>{
